...
public class LanguageConstants {
    ...
    public static String namecantblank = "Name Can't blank";
    public static String locationcantblank = "Location Can't blank";
    public static String phonenumbercantblank = "Phone number Can't blank";
    public static String passwordcantblank = "Password Can't blank";
    public static String invaildEmailFormat = "Invalid email format";
    public static String invailphoneFormat = "Invalid mobile number format";
    ...
    public static String requestdatetime = "Request Date/Time";
    public static String compliantnature = "Compliant Nature";
    ...
    public static String selectcategoryirst = "Select Category";
    public static String selectfieldsfirst = "Select Fields";
    ...
    public static String adminlogin = "Admin Login";
    public static String feedbackDetails = "feedback details";
    public static String companytxt = "Select Company";
    public static String zonetxt = "Select Zone";
    public static String statetxt = "Select State";
    public static String fieldstxt = "Select Fields";
    public static String company = "Company";
    public static String pleaserating = "Please Rating to continue";
    public static String pleaseenterfields = "Please enter the values";
    public static String selectzonefirst = "Select Zone First";
    public static String selectatlestone = "Select atleast one";
    public static String facilityfeedback = "Facility Feedback";
