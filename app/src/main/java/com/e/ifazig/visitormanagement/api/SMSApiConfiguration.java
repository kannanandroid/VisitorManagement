...
public class SMSApiConfiguration {
    ...
    private static SMSApiConfiguration ourInstance = new SMSApiConfiguration();
    Retrofit mRetrofit;

    public static SMSApiConfiguration getInstance() {
        if (ourInstance == null) {
            synchronized (SMSApiConfiguration.class) {
                if (ourInstance == null)
                    ourInstance = new SMSApiConfiguration();
            }
        }
        ourInstance.config();
        return ourInstance;
